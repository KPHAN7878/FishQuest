...
import { StyleSheet, Text, View, FlatList, Dimensions, Button, Modal, Pressable } from 'react-native';
    ...
    <View>
      <View style={styles.missionBox}>
        <View style={styles.missionItem}>
          ...
          <Progress.Bar progress={item.progressPercentage} width={200} height={10} />
                  ...
                  >
                    <View style={styles.centeredView}>
                      <View style={styles.modalView}>
                        <Text style={styles.modalText}>Congrats! You completed this mission!</Text>
                        <Pressable
